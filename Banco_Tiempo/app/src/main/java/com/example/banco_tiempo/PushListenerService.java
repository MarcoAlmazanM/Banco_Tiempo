...
public class PushListenerService extends FirebaseMessagingService {
    ...
    public void onNewToken(String token) {
        ...
        snsTestBAD.getPinpointManager(getApplicationContext()).getNotificationClient().registerDeviceToken(token);
    }
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        final NotificationClient notificationClient = snsTestBAD.getPinpointManager(getApplicationContext()).getNotificationClient();
